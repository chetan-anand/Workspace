...
//    public int[] id = new int[100];
    ...
    MyPanel(){
		...
		icon1 = new ImageIcon("C:\\chip.png","random");
		icon2 = new ImageIcon("C:\\capacitor.png","random");
		icon3 = new ImageIcon("C:\\resistor.png","random");
		icon4 = new ImageIcon("C:\\LED.png","random");
